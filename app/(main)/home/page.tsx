...
export default async function HomePage() {
  ...
  return (
    <main className="flex flex-1 flex-col gap-6 pb-6">
      ...
      {/* docs/design-system.md §7-الف: the page's dominant first element - full-bleed, ~46vh,
          with category navigation pinned on its own bottom edge. Replaces CategoryGrid entirely,
          which used to hold this same job further down the page as a small icon grid. */}
      <HomeHero
        banner={banner ? { imageUrl: banner.imageUrl, text: banner.text, link: banner.link } : null}
