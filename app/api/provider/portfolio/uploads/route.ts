...
// Mirrors app/api/provider/register/uploads/route.ts, except this is a post-approval panel
// feature (not used before a profile exists), so it gates on requireApprovedProvider() instead of
// plain getSession(). See docs/decisions.md ADR 43.
